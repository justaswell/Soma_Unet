...
class RandomFlip:
    ...
    def __init__(self, random_state, axis_prob=0, axes=[0,1,2], **kwargs):
...
class RandomRotate:
    ...
    def __init__(self, random_state, angle_spectrum=60, axes=None, mode='constant', order=0, **kwargs):
        if axes is None:
            axes = [(1, 0), (2, 1), (2, 0)]
        else:
...
class ElasticDeformation:
    ...
    def __init__(self, random_state, spline_order, alpha=150, sigma=10, execution_probability=1, apply_3d=True,
                 **kwargs):
        """
...
class AdditiveGaussianNoise:
    def __init__(self, random_state, scale=(0.0, 0.01), execution_probability=1, **kwargs):
        self.execution_probability = execution_probability
        self.random_state = random_state
        self.scale = scale
...
class AdditivePoissonNoise:
    def __init__(self, random_state, lam=(0.0, 0.01), execution_probability=1, **kwargs):
        self.execution_probability = execution_probability
        self.random_state = random_state
        self.lam = lam
