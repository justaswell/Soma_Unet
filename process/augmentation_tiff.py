...
from preprocess.transform3d import *#RandomFlip,RandomRotate90,RandomRotate,RandomContrast,ElasticDeformation,AdditiveGaussianNoise
...
def main():
    raw_dataset_path = 'D:/A_DLcsz/resizetrain/aug/'
    fixed_dataset_path = 'D:/A_DLcsz/resizetrain/aug/'
